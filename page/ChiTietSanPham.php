...
$truyvan_laySP=$ketnoi->query($laySP);
...
$truyvan_laySanPhamLQ=$ketnoi->query($laySanPhamLQ);

$layDG="SELECT * FROM danhgia WHERE MaSanPham='".$cot["MaSanPham"]."'";
$truyvan_layDG=$ketnoi->query($layDG);
...
if(isset($_SESSION["tendangnhap"])) {
    ...
    $truyvanlayDG_ND=$ketnoi->query($layDG_ND);
...
$truyvan_layBinhLuan=$ketnoi->query($layBinhLuan);
        ...
        <div class="single-main">
            ...
            <div class="col-md-3 p-right single-right">
                ...
                <ul class="product-categories">
                    ...
                    $truyvan_layLoaiSP=$ketnoi->query($layLoaiSP);
...
if($_SERVER["REQUEST_METHOD"]=="POST")
{
    ...
    if(mysqli_query($ketnoi,$themBinhLuan))
    {
