...
if(isset($_GET["MaDonDatXoa"]))
{
    ...
    if(mysqli_query($ketnoi,$xoaDuLieu))
    {
...
$truyvan_layDonDat=mysqli_query($ketnoi,$layDonDat);
if(mysqli_num_rows($truyvan_layDonDat)>0)
{
    ...
    $layCT_DonDat="SELECT  sanpham.*, ct_dondat.* FROM ct_dondat
                ...
                WHERE MaDonDat='".$_GET["MaDonDat"]."'";
    $truyvan_layCT_DonDat=mysqli_query($ketnoi,$layCT_DonDat);
...
if($_SERVER["REQUEST_METHOD"]=="POST") {
    ...
    $truyvan_layNV=mysqli_query($ketnoi,$layNV);
