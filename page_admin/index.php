...
$tongSP=mysqli_num_rows($ketnoi->query("SELECT * FROM sanpham"));
$tongLSP=mysqli_num_rows($ketnoi->query("SELECT * FROM loaisp"));
$tongTV=mysqli_num_rows($ketnoi->query("SELECT * FROM thanhvien"));
$tongNV=mysqli_num_rows($ketnoi->query("SELECT * FROM nhanvien"));
$tongBL=mysqli_num_rows($ketnoi->query("SELECT * FROM binhluan"));
$tongDDH=mysqli_num_rows($ketnoi->query("SELECT * FROM dondat"));
$ddhChua=mysqli_num_rows($ketnoi->query("SELECT * FROM dondat WHERE TrangThai=0"));
$ddhDa=mysqli_num_rows($ketnoi->query("SELECT * FROM dondat WHERE TrangThai=1"));
